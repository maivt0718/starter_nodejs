...
import _restarant from  "./restarant.js";
import _users from  "./users.js";

export default function initModelsAppFood(sequelize) {
  ...
  const restarant = _restarant.init(sequelize, DataTypes);
  ...
  like_res.belongsTo(restarant, { as: "re", foreignKey: "res_id"});
  restarant.hasMany(like_res, { as: "like_res", foreignKey: "res_id"});
  rate_res.belongsTo(restarant, { as: "re", foreignKey: "res_id"});
  restarant.hasMany(rate_res, { as: "rate_res", foreignKey: "res_id"});
